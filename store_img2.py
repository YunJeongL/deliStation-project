...
k = []
store = []
file = open('C:/Users/User/.vscode/week4/project/subwayName1.csv','r')
...
driver = webdriver.Chrome(executable_path='C:/Users/User/.vscode/week4/project/chromedriver.exe')
# 접속
driver.get(MAIN_URL)
