...
k = []
stores = []
file = open('storename1.csv','r')     # 역이름 csv파일 경로 
...
for st in stores:
    ...
    driver.find_element_by_class_name('btn-search').click()
        ...
        #세부페이지 들어감
    driver.find_element_by_xpath('/html/body/main/article/div[2]/div/div/section/div[2]/ul/li[1]/div/figure/figcaption/div/a').click()
    ...
    #print(taglist)
    with open('reviewwords.csv', 'a', encoding='utf-8') as f:  # Just use 'w' mode in 3.x #딕셔너리 ziip csv파일로 만들기
        f.write(str(listt)+'\n')
        f.close()
        print('Output')
    # kaka = '하'
